        ...
        extends BaseAdapter
{
    ...
    public DummyContent(Context paramContext, LinkedList<DummyItem> paramLinkedList)
    {
...
//        ITEMS.add(new DummyItem(11L, "Aidl.class", AidlCilent.class, "A demo", "10-9"));
        ...
        ITEMS.add(new DummyItem(11L, "NewsFragement.class",NewsFragement.class, "A demo", "10-10"));
        ITEMS.add(new DummyItem(11L, "News2.class",Main.class, "A demo", "10-10"));
        ITEMS.add(new DummyItem(11L, "MapActivity.class",MapsActivity.class, "A demo", "10-10"));
        ITEMS.add(new DummyItem(11L, "MapActivity1.class",MapsActivity1.class, "A demo", "10-10"));
        ITEMS.add(new DummyItem(11L, "SettingsActivity.class",SettingsActivity.class, "A demo", "10-10"));
//        ITEMS.add(new DummyItem(11L, "NewsActivity.class",com.example.king.fragement.midea.ItemListActivity.class, "A demo", "10-10"));
//        ITEMS.add(new DummyItem(11L, "NewsActivity1.class",com.example.king.fragement.midea.ItemListActivity1.class, "A demo", "10-10"));
//        ITEMS.add(new DummyItem(11L, "News2.class",BaseFragment.class, "A demo", "10-10"));
//        ITEMS.add(new DummyItem(11L, "AboutUs.class",NewsFragement.class, "A demo", "10-10"));
