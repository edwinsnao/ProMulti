...
// wrong
    ...
    private void setViewOnclickListener() {
        ...
        previousBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        repeatBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        playBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        shuffleBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        nextBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        searchBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        queueBtn.setOnClickListener((View.OnClickListener) ViewOnClickListener);
        music_progressBar.setOnSeekBarChangeListener((SeekBar.OnSeekBarChangeListener) new SeekBarChangeListener());
    }
...
//            shuffleBtn.setBackgroundResource(R.drawable.shuffle_none_selector);
        ...
        else if(flag == AppConstant.PlayerMsg.PLAY_MSG_DIRECT){
            play();
        }
