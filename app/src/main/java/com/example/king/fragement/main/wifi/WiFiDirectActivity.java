...
public class WiFiDirectActivity extends AppCompatActivity implements ChannelListener, DeviceListFragment.DeviceActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_directwifi);
...
//        list = (ListView) findViewById(android.R.id.list);
    ...
    public void onResume() {
        super.onResume();
        receiver = new WiFiDirectBroadcastReceiver1(manager, channel, this);
        ...
        switch (item.getItemId()) {
            case R.id.atn_direct_enable:
                if (manager != null && channel != null) {
                    ...
                    LogWrap.e( "channel or manager is null");
                }
                return true;
    ...
    public void disconnect() {
        ...
        manager.removeGroup(channel, new ActionListener() {
            ...
            @Override
            public void onFailure(int reasonCode) {
                LogWrap.d( "Disconnect failed. Reason :" + reasonCode);
