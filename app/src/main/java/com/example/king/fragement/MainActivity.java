...
// wrong
	...
	class VisitWebRunnable implements Runnable{
		...
		public void run() {
			...
			//				String url_test = URLEncoder.encode("http://www.midea.com/cn/news_center/Group_News/index.shtml","UTF-8");
//				String url_test1 = URLDecoder.decode(url_test, "UTF-8");
//
//				String data = getURLResponse(url_test1);
			resultStr = data;
			//			String data = getURLResponse("http://www.midea.com/cn/news_center/Group_News/index.shtml");
