package com.example.king.fragement.com.example.king.sorting;
...
public class SortingActivity extends Activity implements OnClickListener{
	...
	private Button mInsertSort,mSelectSort,mBubbleSort,mQuickSort,mMergeSort,mHillSort,mHeapSort;
	private TextView mOrign,mSorted;
	private int[] array; 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mInsertSort = (Button) findViewById(R.id.btn_sort_insert);
		mSelectSort = (Button) findViewById(R.id.btn_sort_select);
		mBubbleSort = (Button) findViewById(R.id.btn_sort_bubble);
		mQuickSort = (Button) findViewById(R.id.btn_sort_quick);
		mMergeSort = (Button) findViewById(R.id.btn_sort_merge);
		mHillSort = (Button) findViewById(R.id.btn_sort_shell);
		mHeapSort = (Button) findViewById(R.id.btn_sort_heap);
		
		mOrign = (TextView) findViewById(R.id.txt_orign_number);
		mSorted = (TextView) findViewById(R.id.txt_sorted_number);
		array = new int[]{11, 31, 12, 5, 34, 30, 26, 38, 36, 18};
		mOrign.setText(array2String(array));
		
		mInsertSort.setOnClickListener(this);
		mSelectSort.setOnClickListener(this);
		mBubbleSort.setOnClickListener(this);
		mQuickSort.setOnClickListener(this);
		mMergeSort.setOnClickListener(this);
		mHillSort.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.btn_sort_insert:
			mSorted.setText(array2String(sortInsert(array)));//	 插入排序
			break;
			
		case R.id.btn_sort_select:
			mSorted.setText(array2String(sortSelect(array)));//	 选择排序
			break;

		case R.id.btn_sort_bubble:
			mSorted.setText(array2String(sortBubble(array)));//	冒泡排序
			break;
			
		case R.id.btn_sort_quick:
			mSorted.setText(array2String(sortQuick(array)));//	快速排序
			break;
		case R.id.btn_sort_merge:
			mSorted.setText(array2String(sortMerge(array)));//	 归并排序
			break;
			
		case R.id.btn_sort_shell:
			mSorted.setText(array2String(sortShell(array)));//	 希尔排序
			break;
			
		case R.id.btn_sort_heap:
			mSorted.setText(array2String(sortHeap(array)));//	 堆排序
			break;
		default:
			break;
		}
