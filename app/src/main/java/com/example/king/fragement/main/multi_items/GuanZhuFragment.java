...
import com.example.king.fragement.main.multi_items.GuanZhu;
 ...
 */
public class GuanZhuFragment extends Fragment implements TransferListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.multi_items_guanzhu,container,false);
        lv = (ListView) v.findViewById(R.id.multi_items_guanzhu_lv);
        msg = new Message();
        msg.setType(GuanZhu.VALUE_ZAN);
        msg_list.add(msg);
        msg = new Message();
        msg.setType(GuanZhu.VALUE_ZAN_MUTIL);
        msg_list.add(msg);
        msg = new Message();
        msg.setType(GuanZhu.VALUE_FAQI_HUODONG);
        msg_list.add(msg);
        msg = new Message();
        msg.setType(GuanZhu.VALUE_CANYU_HUODONG);
        msg_list.add(msg);
        lv.setAdapter(new GuanZhu(getContext().getApplicationContext(),msg_list));
        return v;
    }
