...
public class ItemListFragment1
    ...
    * */
    ...
    static ListView list = ItemListActivity1.list;

    public ItemListFragment1(int newsType) {
...
//            mXListView.startRefresh();
            ...
            if (NetUtil.checkNet(getActivity()))
            {
                ...
                isLoadingDataFromNetWork = true;
                 try {
                List<NewsItem> newsItems = mNewsItemDao.list(ItemListFragment1.newsType, ItemListFragment1.currentPage);
                if (newsItems.size() == 0) {
...
//////          paramAnonymousAdapterView = (DummyItem)ItemListFragment1.this.getListAdapter().getItem(paramAnonymousInt);
//////          paramAnonymousAdapterView = new Intent(ItemListFragment1.this.getActivity(), paramAnonymousAdapterView.getActivity());
////// wrong
////// DummyItem item3 = (DummyItem) ItemListFragment1.this.getListAdapter().getItem(paramAnonymousInt);
//////                        Intent it2 = new Intent(ItemListFragment1.this.getActivity(), item3.getActivity());
//////                        ItemListFragment1.this.startActivity(it2);
////                        if (action == null) {
////                            DummyItem item = (DummyItem) ItemListFragment1.this.refresh.getRefreshableView().getAdapter().getItem(paramAnonymousInt);
////                            Intent it = new Intent(ItemListFragment1.this.getActivity(), item.getActivity());
////                            ItemListFragment1.this.startActivity(it);
////                        } else {
////                            switch (action) {
////                                case "com.example.king.sorting":
////                                    DummyContent1.DummyItem item = (DummyContent1.DummyItem) ItemListFragment1.this.refresh.getRefreshableView().getAdapter().getItem(paramAnonymousInt);
////                                    Intent it = new Intent(ItemListFragment1.this.getActivity(), item.getActivity());
////                                    ItemListFragment1.this.startActivity(it);
////                                    break;
////                                case "com.example.king.about":
////                                    DummyContent2.DummyItem item2 = (DummyContent2.DummyItem) ItemListFragment1.this.refresh.getRefreshableView().getAdapter().getItem(paramAnonymousInt);
////                                    Intent it1 = new Intent(ItemListFragment1.this.getActivity(), item2.getActivity());
////                                    ItemListFragment1.this.startActivity(it1);
////                                    break;
////                                default:
////                                    DummyItem item4 = (DummyItem) ItemListFragment1.this.refresh.getRefreshableView().getAdapter().getItem(paramAnonymousInt);
////                                    Intent it3 = new Intent(ItemListFragment1.this.getActivity(), item4.getActivity());
////                                    ItemListFragment1.this.startActivity(it3);
////                                    break;
////
////                            }
////                        }
...
////                        ItemListFragment1.this.startActivity(it2);
//                        if (action == null) {
//                            DummyItem item = (DummyItem) ItemListFragment1.this.getListAdapter().getItem(paramAnonymousInt);
//                            Intent it = new Intent(ItemListFragment1.this.getActivity(), item.getActivity());
//                            ItemListFragment1.this.startActivity(it);
//                        } else {
//                            switch (action) {
//                                case "com.example.king.sorting":
//                                    DummyContent1.DummyItem item = (DummyContent1.DummyItem) ItemListFragment1.this.getListAdapter().getItem(paramAnonymousInt);
//                                    Intent it = new Intent(ItemListFragment1.this.getActivity(), item.getActivity());
//                                    ItemListFragment1.this.startActivity(it);
//                                    break;
//                                case "com.example.king.about":
//                                    DummyContent2.DummyItem item2 = (DummyContent2.DummyItem) ItemListFragment1.this.getListAdapter().getItem(paramAnonymousInt);
//                                    Intent it1 = new Intent(ItemListFragment1.this.getActivity(), item2.getActivity());
//                                    ItemListFragment1.this.startActivity(it1);
//                                    break;
//                                default:
//                                    DummyItem item4 = (DummyItem) ItemListFragment1.this.getListAdapter().getItem(paramAnonymousInt);
//                                    Intent it3 = new Intent(ItemListFragment1.this.getActivity(), item4.getActivity());
//                                    ItemListFragment1.this.startActivity(it3);
//                                    break;
//
...
//        }
        ...
        toolbar = ItemListActivity1.toolbar;
...
//                if(isFirstIn) {
////                    第一次进来，所以固定获取第一页的信息
//                    List<TraceItem> newsItems = mNewsItemDao.list(newsType, 1);
////                    如果数据库没有该数据
//                    if (newsItems.size() == 0) {
//                        List<TraceItem> newsItems1 = mNewsItemBiz.getNewsItems(newsType, 1);
//                        mAdapter.addAll(newsItems1);
//                        MideaFragment1.mNewsItemDao.add(newsItems1);
//                    } else {
//                        mAdapter.addAll(newsItems);
//                    }
//                }
...
////                    如果数据库没有该数据
//                    if (newsItems.size() == 0) {
//                        List<TraceItem> newsItems1 = mNewsItemBiz.getNewsItems(newsType, currentPage);
//                        mAdapter.addAll(newsItems1);
//                        MideaFragment1.mNewsItemDao.add(newsItems1);
//                    } else {
//                        mAdapter.addAll(newsItems);
...
//            mXListView.stopRefresh();
    ...
    static Runnable mAddNewsItem = new Runnable() {
        ...
        public void run() {
            try {
                List<NewsItem> newsItems = mNewsItemBiz.getNewsItems(ItemListFragment1.newsType, ItemListFragment1.currentPage);
//                ItemListFragment1.mNewsItemDao.add(newsItems);
...
class SwpipeListViewOnScrollListener1 implements OnScrollListener {
    ...
    static boolean scrollFlag = ItemListFragment1.scrollFlag;
    ...
    public void onScrollStateChanged(AbsListView absListView, int scrollState) {
        switch (scrollState) {
            ...
            * */
                if (ItemListActivity1.list.getLastVisiblePosition() == (ItemListActivity1.list
                        .getCount() - 1)) {
                    ItemListActivity1.fab.setVisibility(View.VISIBLE);
                ...
                // 判断滚动到顶部
                if (ItemListActivity1.list.getFirstVisiblePosition() == 0) {
                    ItemListActivity1.fab.setVisibility(View.GONE);
                    ItemListActivity1
                            .toolbar.setTitle("Fragment");
                }
    ...
    public void onScroll(AbsListView absListView, int firstVisibleItem,
        ...
        int lastVisibleItemPosition = ItemListFragment1.lastVisibleItemPosition;
...
//            Log.d("dc", "上滑");
//            toolbar = ItemListActivity.toolbar;
            ItemListActivity1.toolbar.setTitle("双击返回顶部");
...
//            toolbar = ItemListActivity.toolbar;
        ...
        if (!ItemListFragment1.mIsLoading && ItemListFragment1.mMoreDataAvailable) {
            if (totalItemCount >= ItemListFragment1.MAXIMUM_ITEMS) {
                ItemListFragment1.mMoreDataAvailable = false;
                ItemListFragment1.list.removeFooterView(ItemListFragment1.mFooterView);
//                refresh.getRefreshableView().removeFooterView(mFooterView);
            } else if (totalItemCount - ItemListFragment1.AUTOLOAD_THREADSHOLD <= firstVisibleItem + visibleItemCount)
//        else
            {
                ItemListFragment1.mIsLoading = true;
                ItemListFragment1.currentPage++;
                List<NewsItem> newsItems = ItemListFragment1.mNewsItemDao.list(ItemListFragment1.newsType, ItemListFragment1.currentPage);
               /*
...
//                Log.d("newsItems in News:",String.valueOf(newsItems.get(0)));
                ...
                * */
                if(newsItems.size()==0)
                ItemListFragment1.handler.postDelayed(ItemListFragment1.mAddNewsItem,1000);
//                ItemListFragment1.handler.postDelayed(ItemListFragment1.mAddItemsRunnable, 1000);
//                ItemListFragment1.currentPage++;
//                if (ItemListFragment1.isLoadingDataFromNetWork) {
//                    ItemListFragment1.currentPage += 1;
//
//
//                }
                else
...
//                    List<TraceItem> newsItems = ItemListFragment.mNewsItemDao.list(ItemListFragment.newsType, ItemListFragment.currentPage);
                    ItemListFragment1.mAdapter.addAll(newsItems);
                    ItemListFragment1.mAdapter.notifyDataSetChanged();
                    ItemListFragment1.mIsLoading = false;
                }
            }
//            new ItemListFragment1.LoadDatasTask().execute();
        }
    }
}
...
/* Location:              D:\迅雷下载\dex2jar-2.0\classes-dex2jar.jar!\com\example\king\fragement\ItemListFragment1.class
