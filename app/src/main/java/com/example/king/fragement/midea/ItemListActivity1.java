...
// */
//public class ItemListActivity1 extends AppCompatActivity
//        implements ItemListFragment1.Callbacks{
...
//        setContentView(R.layout.activity_item_app_bar2);
//         /*
...
////            @Override
////            public void run() {
////                Toast.makeText(ItemListActivity1.this, "width:"+v.getWidth()+"height:"+v.getHeight(), Toast.LENGTH_SHORT).show();
////            }
////        });
...
////                }
////            });
////            Toast.makeText(ItemListActivity1.this, "当前网络链接不可用，请稍后尝试", Toast.LENGTH_SHORT).show();
////        }
...
////                break;
////            case R.id.settings:
////                Intent it3 = new Intent(ItemListActivity1.this,SettingsActivity.class);
////                startActivity(it3);
...
//                LogWrap.d( "MyToast Exception--->" + ItemListActivity1.this.toString());
//            }
//        }
//
//        public void hide() {
...
////        this.network.append("\nx : " + j);
////        this.network.append("\ny : " + k);
////        Toast.makeText(ItemListActivity1.this, "x:"+j+"y:"+k, Toast.LENGTH_SHORT).show();
//    }
